...
[Serializable]
public class VFXDay23CutomPostProcessPass : ScriptableRenderPass
{
    ...
    private const int k_MaxPyramlidSize = 16;
    private int[] _BloomMipUp;
    private int[] _BloomMipDown;
    private RTHandle[] m_BloomMipUp;
    private RTHandle[] m_BloomMipDown;
    private GraphicsFormat hdrFormat;
    private VFXDay23BanDAyBloomComponent m_bloomEffect;

    public VFXDay23CutomPostProcessPass(Material bloomMat, Material compositeMat)
    {
        ...
        _BloomMipUp = new int[k_MaxPyramlidSize];
        _BloomMipDown = new int[k_MaxPyramlidSize];
        m_BloomMipUp = new RTHandle[k_MaxPyramlidSize];
        m_BloomMipDown = new RTHandle[k_MaxPyramlidSize];

        for (int i = 0; i < k_MaxPyramlidSize; i++)
        {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        m_bloomEffect = stack.GetComponent<VFXDay23BanDAyBloomComponent>();
