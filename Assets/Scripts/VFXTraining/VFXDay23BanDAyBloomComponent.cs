...
[VolumeComponentMenuForRenderPipeline("Custom/VFXDay23BenDAyBloom", typeof(UniversalRenderPipeline))]
public class VFXDay23BanDAyBloomComponent : VolumeComponent, IPostProcessComponent
{
    ...
    public ClampedFloatParameter dotsCutoff = new ClampedFloatParameter(0.4f, 0, 1f, true);
